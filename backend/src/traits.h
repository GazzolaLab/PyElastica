...
inline auto get_column_slice(MatrixType& matrix, std::size_t start_col, std::size_t num_cols) {
    return matrix.middleCols(static_cast<IndexType>(start_col),
                             static_cast<IndexType>(num_cols));
}
...
inline auto get_block_slice(MatrixType& matrix,
    ...
    return matrix.block(static_cast<IndexType>(start_row),
                        static_cast<IndexType>(start_col),
