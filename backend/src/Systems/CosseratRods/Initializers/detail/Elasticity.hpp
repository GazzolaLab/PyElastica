  ...
  namespace cosserat_rod {
    ...
    namespace detail {
      ...
      namespace option_tags {
        ...
        // struct ForceDampingRate : elastica::Parameter<elastica::real_t> {
        //   using elastica::Parameter<elastica::real_t>::Parameter;
        //   using type = elastica::real_t;
        //   // static type lower_bound() noexcept { return 0.0; }
        //   using TagType = elastica::tags::ForceDampingRate;
        // };
        ...
        // struct TorqueDampingRate : elastica::Parameter<elastica::real_t> {
        //   using elastica::Parameter<elastica::real_t>::Parameter;
        //   using type = elastica::real_t;
        //   // static type lower_bound() noexcept { return 0.0; }
        //   using TagType = elastica::tags::TorqueDampingRate;
        // };
      ...
      class LinearHyperElasticModel {
       public:
        ...
        decltype(auto) get_required_parameters(
          ...
          // const auto material_id = std::get<option_tags::Material>(options_cache).value();
          const real_t E = std::get<option_tags::Youngs>(options_cache).value();
          // const real_t E = Material::get_youngs_modulus(material_id);
          const real_t G = std::get<option_tags::ShearModulus>(options_cache).value();
