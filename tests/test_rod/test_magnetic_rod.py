...
def test_magnetic_magnetization_collection(n_elems):
    ...
    assert_allclose(
        magnetic_rod.director_collection, director_collection, atol=Tolerance.atol()
    )

    magnetization_direction_in_material_frame = _batch_matvec(
        director_collection, magnetization_direction
    )
    correct_magnetization_collection = (
        magnetization_density * volume * magnetization_direction_in_material_frame
    )

    assert_allclose(
        magnetic_rod.magnetization_collection,
        correct_magnetization_collection,
        atol=Tolerance.atol(),
    )
