...
def test_calculate_contact_forces_self_rod():
    ...
    rod_radius_collection = np.array(
        [0.12952263, 0.19493561, 0.72904683, 0.21676892, 0.18705351]
    )
    ...
    assert_allclose(
        ...
        np.array(
            [
                [-0.773064, -0.25648, -0.934193, -0.77665, -0.333459],
                [-1.048342, -1.922505, -1.465054, -0.711924, -0.992566],
                [0.334656, 1.228715, 0.062506, -0.495317, 0.580447],
            ]
        ),
        rtol=tol,
        atol=tol,
