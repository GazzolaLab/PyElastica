...
plt.plot(recorded_history["time"], mass_center[:, 0], label="x")
plt.plot(recorded_history["time"], mass_center[:, 1], label="y")
plt.plot(recorded_history["time"], mass_center[:, 2], label="z")
