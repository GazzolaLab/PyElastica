...
# TODO: Consider removing. Part of the explicit stepper that we are dropping the supports.
...
# Note: Keep the code. Maybe reuse later. If we drop explicit stepper, remove the code.
# It is commented out because we don't need it. Related to explicit stepper
