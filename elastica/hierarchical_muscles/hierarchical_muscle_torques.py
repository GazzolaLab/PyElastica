...
if IMPORT_NUMBA:
    from elastica._elastica_numba._hierarchical_muscles._hierarchical_muscle_torques import (
        HierarchicalMuscleTorques,
    )
else:
    from elastica._elastica_numpy._hierarchical_muscles._hierarchical_muscle_torques import (
        HierarchicalMuscleTorques,
    )
