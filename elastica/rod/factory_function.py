...
ring_center_position : NDArray[3, float]
    Ring center position coordinate in 3D
...
def allocate_ring_rod(
    ...
    **kwargs,
    ...
    _position_validity_checker_ring_rod(position, ring_center_position, n_elements)
    ...
    _assert_shape(rest_kappa, (MaxDimension.value(), n_elements), "rest_kappa")
