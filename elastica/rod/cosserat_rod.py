...
class CosseratRod(
    ...
    Although position, velocity, acceleration, angular velocity, and angular acceleration are set and
    referenced in _RodSymplecticStepperMixin class, for users convenience variable names for those
    are given below.
