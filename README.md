...
- [Digital twins for the design, interactive control, and deployment of modular, fiber-reinforced soft continuum arms](https://arxiv.org/abs/2507.10121) (2026) (Advanced Intelligent Systems)
- [Elastica++: A high-performance, multiphysics framework for large interacting assemblies of Cosserat rods](https://arxiv.org/abs/2605.13766) (2026)
- [Soft, slender and active structures in fluids: embedding Cosserat rods in vortex methods](https://doi.org/10.48550/arXiv.2401.09506) (2024)
- [Neural models and algorithms for sensorimotor control of an octopus arm](https://doi.org/10.48550/arXiv.2402.01074) (2024)
- [On the mechanical origins of waving, coiling and skewing in Arabidopsis thaliana roots](https://www.pnas.org/doi/10.1073/pnas.2312761121) (2024) (PNAS)
- [Pushing with soft robotic arms via deep reinforcement learning](https://doi.org/10.1002/aisy.202300899) (2024) (Advanced Intelligent Systems)
- [Topology, dynamics, and control of an octopus-analog muscular hydrostat](https://arxiv.org/abs/2304.08413) (2023)
- [Hierarchical control and learning of a foraging CyberOctopus](https://onlinelibrary.wiley.com/doi/full/10.1002/aisy.202300088) (2023) (Advanced Intelligent Systems)
- [Energy-shaping control of a muscular octopus arm moving in three dimensions](https://royalsocietypublishing.org/doi/full/10.1098/rspa.2022.0593) (2023) (Proceedings of the Royal Society A 2023)
- [Ablation study of a dynamic model for a 3d-printed pneumatic soft robotic arm](https://doi.org/10.1109/ACCESS.2023.3266282) (2023) (IEEE Access)
- [Learning a controller for soft robotic arms and testing its generalization to new observations, dynamics, and tasks](https://doi.org/10.1109/ROBOSOFT55895.2023.10121988) (2023) (IEEE RoboSoft 2023)
- [A sensory feedback control law for octopus arm movements](https://ieeexplore.ieee.org/abstract/document/9993021/) (2022) (IEEE CDC 2022)
- [Control-oriented modeling of bend propagation in an octopus arm](https://ieeexplore.ieee.org/abstract/document/9867689/) (2021) (IEEE ACC 2022)
- [A physics-informed, vision-based method to reconstruct all deformation modes in slender bodies](https://arxiv.org/abs/2109.08372) (2021) (IEEE ICRA 2022) [code](https://github.com/GazzolaLab/BR2-vision-based-smoothing)
- [Optimal control of a soft CyberOctopus arm](https://ieeexplore.ieee.org/document/9483284) (2021) (IEEE ACC 2021)
- [Elastica: A compliant mechanics environment for soft robotic control](https://ieeexplore.ieee.org/document/9369003) (2021) (IEEE RA-L 2021)
- [Controlling a CyberOctopus soft arm with muscle-like actuation](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=9683318) (2020) (IEEE CDC 2021)
- [Energy shaping control of a CyberOctopus soft arm](https://ieeexplore.ieee.org/document/9304408) (2020) (IEEE CDC 2020)
...
[badge-doi]: https://img.shields.io/badge/DOI-10.5281%2Fzenodo.20799824-blue
...
[link-doi]: https://doi.org/10.5281/zenodo.20799824
